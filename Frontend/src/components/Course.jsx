...
function Course(){
    return(
        ...
        <div className="max-w-screen-2x1 container mx-auto md:px-20 px-4">
            ...
            <h2 className="text-xl font-semibold md:text-3xl mt-12">4. Story Books
                <span className="text-xl font-semibold md:text-3xl mt-12 text-blue-700">-Perfect bedtime companion</span>
            </h2>
            <p className="text-xl md:text-2xl mt-8">We offer you a wide range of story books to relax over time when you are stressed out or 
                looking out for a good bedtime story
            </p>
